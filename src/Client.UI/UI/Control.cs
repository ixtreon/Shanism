...
namespace Shanism.Client.UI
{
    ...
    public partial class Control
    {
        ...
        static IShanoComponent env;

        protected static Screen Screen => env.Screen;
        protected static ContentList Content => env.Content;
        protected static KeyboardInfo KeyboardInfo => env.Keyboard;
        protected static MouseInfo MouseInfo => env.Mouse;


        public static void SetContext(IShanoComponent env)
        {
            Control.env = env;
        }
        ...
        /// is activated (pressed or released as per <see cref="KeyboardInfo.QuickButtonPress"/>)
