...
namespace Shanism.ScenarioLib
{
    static class Ext
    {
        ...
        public static string GetHumanReadableString(this Diagnostic d, string rootDir)
        {
            ...
            var filePath = ShanoPath.GetRelativePath(rootDir, d.Location.SourceTree.FilePath);
        ...
        public static IEnumerable<InvocationExpressionSyntax> GetInvocations(this SyntaxTree t)
            => t.GetNodes<InvocationExpressionSyntax>();

        public static IEnumerable<SyntaxNode> GetAllNodes(this SyntaxTree t)
            => t.GetRoot().DescendantNodesAndSelf();

        public static IEnumerable<T> GetNodes<T>(this SyntaxTree t)
            => t.GetRoot()
            .DescendantNodesAndSelf()
            .OfType<T>();
    }
