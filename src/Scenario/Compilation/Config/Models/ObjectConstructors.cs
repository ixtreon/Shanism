...
namespace Shanism.ScenarioLib
{
    ...
    /// a <see cref="Common.Entities.IEntity"/> at map startup. 
    /// </summary>
    public class ObjectConstructor
    {
        ...
        /// <summary>
        /// The full name of the particular type of <see cref="Common.Entities.IEntity"/> that is created. 
        /// </summary>
        public string TypeName { get; set; }

        /// <summary>
        /// The owner of the entity that is to be created. 
        /// Only used with objects inheriting <see cref="Common.Entities.IUnit"/>. 
        /// </summary>
