...
namespace ShanoEditor.Views.Models
{
    partial class TextureBox : UserControl
    {
        ...
        bool tryGetCell(Point cursorPos, out IO.Common.Point clampedPos)
        {
        ...
        void extendSelect(Point mousePos)
        {
            ...
            rawSelection = new IO.Common.Rectangle(rawSelection.Position, cellPos - rawSelection.Position);
