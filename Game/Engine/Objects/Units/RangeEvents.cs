...
namespace Engine.Objects
{
    partial class Unit
    {
        ...
        public int RegisterRangeEvent(Vector pos, double range, EventType evType, Action<RangeArgs<Unit>> act)
        {
            return addConstraint(new UnitRangeConstraint(this, pos, range, evType, act));
        }

        public int RegisterRangeEvent(Unit other, double range, EventType evType, Action<RangeArgs<Unit>> act)
        {
        ...
        public int RegisterInRangeOf(Vector pos, double range, Action<RangeArgs<Unit>> act)
        {
            return addConstraint(new UnitRangeConstraint(this, pos, range, EventType.EntersRange, act));
        }

        public int RegisterLeavesRangeOf(Vector pos, double range, Action<RangeArgs<Unit>> act)
        {
            return addConstraint(new UnitRangeConstraint(this, pos, range, EventType.LeavesRange, act));
        }


        public int RegisterInRangeOf(Unit other, double range, Action<RangeArgs<Unit>> act)
        {
            return addConstraint(new UnitRangeConstraint(this, other, range, EventType.EntersRange, act));
        }

        public int RegisterLeavesRangeOf(Unit other, double range, Action<RangeArgs<Unit>> act)
        {
