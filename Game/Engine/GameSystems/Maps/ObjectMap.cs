...
namespace Shanism.Engine.Maps
{
    class ObjectMap : HashMap<Point, Entity>
    {
        ...
        {
            return new HashSet<Entity>(RawRangeQuery(rect).Where(obj => rect.Contains(obj.Position)));
        }


        /// <summary>
        /// Executes a fast range query for all objects lying inside or around the given rectangle. 
        /// Returned units may not actually lie in the provided rectangle or may be returned more than once. 
        /// </summary>
