...
namespace Client
{
    class ObjectSystem : Control, IClientSystem
    {
        public static readonly ObjectSystem Default = new ObjectSystem();
        ...
        public void HandleMessage(IOMessage ioMsg)
        {
            switch(ioMsg.Type)
            {
                ...
                case MessageType.ObjectUnseen:
                    RemoveObject(((ObjectUnseenMessage)ioMsg).Guid);
                    break;
